...
def calculate_demographic_data(print_data=True):
    ...
    num_min_workers = df[df['hours-per-week'] == min_work_hours]['hours-per-week'].value_counts()
    ...
    highest_earning_country_percentage = df[df.salary == '>50K']['native-country'].value_counts().max()/len(df)

    # Identify the most popular occupation for those who earn >50K in India.
    top_IN_occupation = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')].groupby('occupation')['occupation'].value_counts().idxmax()
